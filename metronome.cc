...
static void processCommandLine(int argc, char** argv)
{
  ...
  desc.add_options()("help,h", "produce help message")("carbon-address", po::value<string>()->default_value("[::]:2003"), "Accept carbon data on this address")("carbon-timeout", po::value<unsigned int>()->default_value(5), "Maximum time in seconds to send a carbon line")("webserver-address", po::value<string>()->default_value("[::]:8000"), "Provide HTTP service on this address")("webserver-timeout", po::value<unsigned int>()->default_value(5), "Maximum time in seconds to send an HTTP request line")("http1.0", "If set, use http 1.0 semantics for lighttpd proxy")("quiet", po::value<bool>()->default_value(true), "don't be too noisy")("daemon", po::value<bool>()->default_value(true), "run in background")("disable-syslog", "don't log to syslog")("stats-directory", po::value<string>()->default_value("./stats"), "Store/access statistics from this directory");
